...
namespace TMS
{
    public partial class frmMain : Form
    {
            ...
            string text = string.Concat(new string[]
      {
            ...
            //StreamWriter sw = new StreamWriter("cache\\arhiva\\" + _selectedCountry.CountryName + "\\"
            //    + this._selectedCompetition.CompetitionName +
            //    " [" + this._selectedCompetition.CompetitionId.ToString() +
            //    "] " +
            //    "schedule.txt");

            //StreamReader sw = new StreamReader("cache\\arhiva\\" + _selectedCountry.CountryName + "\\"
            //    + this._selectedCompetition.CompetitionName +
            //    " [" + this._selectedCompetition.CompetitionId.ToString() +
            //    "] " +
            //    "schedule.txt");
            ...
            foreach (Team t in _selectedCompetition.Teams)
            {
                ...
                //{
                    ...
                    //var homeTeam = line.Split('|')[0];
                    //var awayTeam = line.Split('|')[1];
                    ...
                    //m.Result = result;
                    //DateTime mdate;
                    //bool s = DateTime.TryParseExact(date, "M/dd/yyyy h:mm:ss tt", null, DateTimeStyles.None, out mdate);
                    //if (s == true)
                    //    m.Date = mdate;
                    //m.HomeTeam = _cachedTeams.Where(ct => ct.TeamId == int.Parse(homeTeam)).FirstOrDefault();
                    //m.VisitingTeam = _cachedTeams.Where(ct => ct.TeamId == int.Parse(awayTeam)).FirstOrDefault();
                    //t.Schedule.Add(m);
                    ...
                    //    sw.WriteLine(s.HomeTeam.TeamId + "|" + s.VisitingTeam.TeamId + "|" + s.Result + "|" + s.Date + "|");
                //}
            }
