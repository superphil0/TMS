      ...
      XLColor.LightBrown
        ...
        private static void CreateScheduleStylesheet(Competition c, XLWorkbook xLWorkbook)
        {
            ...
            try
            {
                ...
                iXLWorksheet.Columns(1, 1).Width = 5;
                iXLWorksheet.Style.Font.SetFontSize(7);
        ...
        XLColor.FromArgb(189, 146, 222), XLColor.FromArgb(255, 255, 255), XLColor.FromArgb(255, 255, 255), XLColor.FromArgb(191, 143, 0), XLColor.FromArgb(191, 143, 0) };
                ...
                for (int i = 0; i < c.Teams.Count; i++)
                {
                    ...
                    for (int m = 0; m < teamSchedule.Count; m++)
                    {
                        ...
                        hgCell.Style.Font.SetFontSize(16);
                        agCell.Style.Font.SetFontSize(16);
                        ...
                        cell.Style.Fill.BackgroundColor = XLColor.FromArgb(255, 201, 105);
                        cell.SetFormulaA1("SUM((((Q5 * 100) / ((F5 / E5) * 100)) - P5))");

                        iXLWorksheet.Cell((8 * m) + 3, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 255);
                        iXLWorksheet.Cell((8 * m) + 3, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 255);

                        //red 1
                        iXLWorksheet.Cell((8 * m) + 4, 26 * (i + 1) - 2).Style.Fill.BackgroundColor = XLColor.FromArgb(169, 208, 142);
                        iXLWorksheet.Cell((8 * m) + 4, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);
                        iXLWorksheet.Cell((8 * m) + 4, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);

                        //red 2                        
                        iXLWorksheet.Cell((8 * m) + 5, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);
                        iXLWorksheet.Cell((8 * m) + 5, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);

                        //red 3                       
                        iXLWorksheet.Cell((8 * m) + 6, 26 * (i + 1) - 2).Style.Fill.BackgroundColor = XLColor.FromArgb(0, 176, 240);
                        iXLWorksheet.Cell((8 * m) + 6, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);
                        iXLWorksheet.Cell((8 * m) + 6, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);

                        //red 4
                        iXLWorksheet.Cell((8 * m) + 7, 26 * (i + 1) - 2).Style.Fill.BackgroundColor = XLColor.FromArgb(0, 176, 240);
                        iXLWorksheet.Cell((8 * m) + 7, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);
                        iXLWorksheet.Cell((8 * m) + 7, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);

                        //red 5
                        iXLWorksheet.Cell((8 * m) + 8, 26 * (i + 1) - 2).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 201, 105);
                        iXLWorksheet.Cell((8 * m) + 8, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);
                        iXLWorksheet.Cell((8 * m) + 8, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(255, 255, 0);

                        //red 6
                        iXLWorksheet.Cell((8 * m) + 9, 26 * (i + 1) - 2).Style.Fill.BackgroundColor = XLColor.FromArgb(169, 208, 142);
                        iXLWorksheet.Cell((8 * m) + 9, 26 * (i + 1) - 1).Style.Fill.BackgroundColor = XLColor.FromArgb(146, 208, 80);
                        iXLWorksheet.Cell((8 * m) + 9, 26 * (i + 1)).Style.Fill.BackgroundColor = XLColor.FromArgb(146, 208, 80);
                    }
                }
            }
            catch (Exception e)
